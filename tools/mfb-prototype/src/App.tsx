  ...
  return (
    <div className="app">
      <aside className="rail">
        ...
        <h1>Messages for Business stand-in</h1>
        <p className="lede">
          Quick replies, list pickers, and forms shaped like Apple&apos;s{" "}
          <code>interactiveData</code> — enough to prototype Penny&apos;s audit without an MSP.
        </p>
      ...
      <main className="phone">
        <header className="phone-header">
          ...
          <div>
            ...
            <div className="phone-sub">Business · prototype</div>
          </div>
        </header>
        ...
        {activeQuickReply ? (
          ...
          <div className="composer-disabled">Use the controls Penny sends — no free typing in this demo</div>
        )}
      </main>
